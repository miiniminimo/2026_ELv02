...
const AWARDS = [
  {
    ...
    items: [
      ...
      { medal: '📋', cls: 'bronze', name: '연합동아리 University Makeus Challenge 10기 수료 (13명)', org: '2026' },
      { medal: '🥇', cls: 'gold',   name: '앵커사업 학생참여형 리빙랩 최우수상',                   org: '2026' },
      { medal: '🥈', cls: 'silver', name: '도전! 메가시티리그전 우수상',                           org: '2026' },
      ...
      { medal: '📋', cls: 'bronze', name: '연합동아리 University Makeus Challenge 9기 수료 (5명)', org: '2026' },
    ],
  },
  {
    year: '2025',
